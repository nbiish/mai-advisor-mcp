...
## Executive Summary
This framework provides research methodologies and evidence-gathering strategies specifically designed for small non-profit operations developing indigenous non-profit. Focus is on leveraging existing data, demonstrating community need, and building evaluation capacity that funders value.
